...
namespace OneCardSystem.Recognizer
{
    public class AmFaceVerify
    {
        ...
        * @return 初始化人脸跟踪引擎
        */
        [DllImport("libarcsoft_fsdk_face_tracking.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int AFT_FSDK_InitialFaceEngine(string appId, string sdkKey, IntPtr pMem, int lMemSize, ref IntPtr pEngine, int iOrientPriority, int nScale, int nMaxFaceNum);

        /**
        * 获取人脸跟踪SDK 版本信息
        * @return 获取人脸跟踪SDK 版本信息
        */
        [DllImport("libarcsoft_fsdk_face_tracking.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr AFT_FSDK_GetVersion(IntPtr pEngine);
        ...
        */
        [DllImport("libarcsoft_fsdk_face_tracking.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int AFT_FSDK_FaceFeatureDetect(IntPtr pEngine, IntPtr offline, ref IntPtr faceResult);
